...
public class Incidencia {
    ...
    public Incidencia(String tipo, String medicamentoAfectado, int cantidadAfectada, LocalDate fechaIncidente,
            String descripcion) {
        this.tipo = tipo;
    ...
    public String getMedicamentoAfectado() {
        return medicamentoAfectado;
    }

    public void setMedicamentoAfectado(String medicamentoAfectado) {
        this.medicamentoAfectado = medicamentoAfectado;
    }
